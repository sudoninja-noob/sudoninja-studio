...
The big animated hero, mode selector, presets, model picker, and the full composition form.

![Studio](docs/screenshots/01-studio.png)

### Settings — backend, defaults, language, local data
Wire the backend, set generation defaults, switch language (English / हिन्दी), and clear local data.
...
### Fully responsive
Works on mobile — the sidebar collapses to a drawer.
